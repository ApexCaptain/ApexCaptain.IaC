...
@Injectable()
export class K8S_Oke_Apps_Metrics_Server_Stack extends AbstractStack {
  terraform = {
  ...
  metadata = this.provide(Resource, 'metadata', () => [
    {},
    this.k8sOkeSystemStack.applicationMetadata.shared.metricsServer,
  ]);
  ...
  constructor(
    ...
    super(
      ...
      K8S_Oke_Apps_Metrics_Server_Stack.name,
      'Metrics server stack for oke k8s',
    );
  }
}
