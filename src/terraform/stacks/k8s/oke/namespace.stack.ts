...
export class K8S_Oke_Namespace_Stack extends AbstractStack {
  terraform = {
    ...
    // ssh -i <privateKey> -N -L <localPort>:10.0.0.2:6443 -p 22 ocid1.bastionsession.oc1.ap-chuncheon-1.amaaaaaau24mzhaamolqcfxmelf6754ul5x3hqqekqykykhjbn5nv4cehrea@host.bastion.ap-chuncheon-1.oci.oraclecloud.com
    providers: {
      ...
      //   () => ({
      //     configPath:
      //       this.ociOkeStack.okeClusterKubeConfigFile.element.filename,
      //     insecure: true,
      //     exec: [
      //       {
      ...
      //           '-i',
      //           this.ociBastionStack.okeBastionSshKeyPrivateOpenSshFileInKeys
      //             .element.filename,
      //           '-N',
      //           '-L',
      //           '6443:10.0.0.2:6443',
      //           '-p',
      //           '22',
      //           `${this.ociBastionStack.okeBastionK8sEndpointSession.element.id}@host.bastion.ap-chuncheon-1.oci.oraclecloud.com`,
      //         ],
      //       },
      //     ],
      //   }),
